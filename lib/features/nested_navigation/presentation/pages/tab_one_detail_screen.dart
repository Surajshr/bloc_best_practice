...
class TabOneDetailScreen extends StatelessWidget {
  const TabOneDetailScreen({super.key});
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const BuildText(
                text: 'Tab One Detail Screen!',
                fontSize: 24,
                fontWeight: FontWeight.bold,
              ),
              SizedBox(height: 20.h),
              const BuildText(
                text: 'This is a detail screen within Tab One.',
                fontSize: 16,
                color: AppColors.kTextDisabledColor,
              ),
              SizedBox(height: 20.h),
              const BuildText(
                text: 'Notice the bottom navigation is still visible!',
                fontSize: 16,
